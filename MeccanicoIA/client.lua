...
function GoToTarget(x, y, z, vehicle, driver, vehhash, target)
    ...
    ShowAdvancedNotification(companyIcon, companyName, "Meccanico inviato, un meccanico è stato inviato nella tua posizione. Grazie per aver scelto la nostra compagnia ~y~" .. companyName)
    enroute = true
    while enroute do
        Citizen.Wait(500)
